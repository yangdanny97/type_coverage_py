...
def download_typeshed_csv() -> Dict[str, Dict[str, Any]]:
    ...
    for row in csv_reader:
        ...
        param_percent: float = generate_coverage_percent(annotated_parameters, unannotated_parameters)
        return_percent: float = generate_coverage_percent(annotated_returns, unannotated_returns)
